    ...
    while(fgets(line, 10, stdin)){
        ...
        if(action == 'r'){
            if(vir_page[page].virtual_page == -1){
                ...
                if(vir_page[page].physical_page != -1){
                ...
                else if(vir_page[page].physical_page == -1){
                    int i = 0;
                    while(i < physical){
                        if(phys_page[i] == -1){
                            printf("Time %d: virtual page %d  - read access - loaded to physical page %d\n",time, page, i);
                            vir_page[page].physical_page = i;
                            phys_page[i] = page;
                            vir_page[page].last_access_time = time;
                            break;
                        }
                    ...
                    if(vir_page[page].physical_page == -1 && i == physical){
                        ...
                        phys_page[vir_page[temp1].physical_page] = page;
            ...
            if(vir_page[page].physical_page == -1){
                ...
                vir_page[page].last_access_time = time;
                phys_page[vir_page[page].physical_page] = -1;
